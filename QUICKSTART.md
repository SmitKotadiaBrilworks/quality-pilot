...
```
Frontend (Next.js) → Backend (Node.js) → AI (Gemini) → Playwright → Browser
                    ↓
...
✅ **AI-Powered** - Gemini converts prompts to test steps  
✅ **Live Execution** - Watch tests run in real-time  
✅ **Secure Credentials** - Encrypted, never exposed to AI  
✅ **Multi-Browser** - Chromium, Firefox, WebKit support  
✅ **Screenshots** - Automatic screenshots after each step
